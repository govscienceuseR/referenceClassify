...
packs = c('data.table', 'dplyr', 'stringr', 'keras', 'tensorflow', 'magrittr')
...
```{r}
write.csv(dt, "~/Documents/Davis/R-Projects/citationClassify/data/predicted_class.csv", row.names = F)
```
